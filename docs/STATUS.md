...
| extract/deterministic/* (7) | §10.1 | ✅ | package-scripts, editorconfig, tsconfig, lockfile, ci, generated-markers, agent-files |
...
_Last updated: high-trust tsconfig deterministic extraction, high-entropy redaction hardening, repo-id-isolated temporal validity, measured hook latency, fail-closed adapter install/uninstall, and typed CLI error formatting. 195 tests, 19 gate suites green, all I1-I9 hold._

_Quality counters: Tests: 195. Gate suites: 19._
...
measured gains are recorded in the `memory` graph. Tests: 195, gate suites: 19 (`eval all` includes run/memory/promote/drift/retrieval/gate/security/branch/temporal/conflict/procedure/mcp/storage/telemetry/provenance/resilience/benchmarks/cli-docs-demo/quality)._
