...
| cli.ts | §19 | ✅ | init/install(claude\|cursor\|opencode\|generic\|auto)/uninstall/hook/recall/remember/loop/resolve/extract/serve --mcp/why/doctor/demo/skill/tui/compare/bench/eval |
...
measured gains are recorded in the `memory` graph. Tests: 286, gate suites: 19 (`eval all` includes run/memory/promote/drift/retrieval/gate/security/branch/temporal/conflict/procedure/mcp/storage/telemetry/provenance/resilience/benchmarks/cli-docs-demo/quality)._
